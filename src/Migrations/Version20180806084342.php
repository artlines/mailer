...
final class Version20180806084342 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("INSERT INTO public.client (id, title, alias, sender_email, allow_ips, client_secret, is_active, created_at, updated_at) VALUES (4, 'mailer', 'mailer', 'no-reply@nag.ru', null, '181b21a16ecef7472c05543164e6b5f3', true, '2018-08-06 09:54:25', '2018-08-06 09:55:15');");
